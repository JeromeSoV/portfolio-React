...
Découverte de l’environnement économique consiste en plusieurs projets sollicitant
...
![Page d’accueil de notre site web](./img/accueil.png)

![Exemple de page de notre site web.](./img/exemplePage.png)

![Diagnostic stratégique de Google](./img/swot.png)
...
### Mes réussites dans ce projet

Les compétences principales que j’ai acquises durant ce projet sont les compétences
informatiques. Faire des recherches sur des entreprises et travailler la communication que
l’on peut faire autour d’un texte sont des compétences que j’ai déjà eu l’occasion de
travailler bien avant compte tenu de mon parcours. Ainsi les compétences informatiques
mentionnées plus tôt passant par la compréhension et un début de maîtrise des langages
html et css étaient les compétences que j’ai le plus travaillé durant ce projet sont mes
compétences acquises. les savoir-faire non informatiques faisaient mes points forts et j’ai su
les exploiter convenablement.

### Mes difficultés dans la mise en œuvre du projet

Ma difficulté principale était comme suggéré plus tôt la compréhension des langages utilisés.
Bien que leur fonctionnement soit simple et assez clair et qu’il est très facile de se rendre
compte de si ce que l’on fait est bien ou pas, j’avais de vrais soucis à appréhender
l’utilisation de ces outils.

### Mes points à améliorer

Au final concernant mes difficultés sur ce projet je pense avoir rejoint les compétences
demandées dans l’utilisation de ces outils. Ainsi je pense avoir une maîtrise adaptée au
niveau attendu sur les compétences que le projet nécessitait pour être mené.

## Conclusion

Au sein de mon trinôme, ayant eu plus de volonté d’assumer la partie économique,
j’ai décidé de me concentrer sur cette partie principalement, avec une aide
ponctuelle de mes équipiers tandis qu’eux se concentraient sur le site web. Après,
voulant tout de même avoir une participation dans la conception du site, une fois la
partie économie terminée, j’ai pris un peu de retard sur ma partie web et ai comme
pris un train déjà en marche. Ainsi la partie web a été menée, mais avec mes
difficultés mentionnées plus tôt, j’ai pu rendre à temps ma partie web, ceci dit un peu
sur le fil. Ceci dit, d'ici mon BUT 2 je compte me renforcer sur la conception des sites
web, par exemple dans le cadre d’une réalisation d’un portfolio professionnel. Il
faudrait donc que j’apprenne à un peu mieux utiliser les langages permettant sa
création. Cela a au moins une influence dans mon projet personnel, sur la façon de
réfléchir à comment me vendre auprès des employeurs.
